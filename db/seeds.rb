...
shoreditch = Flat.new(title:"Modern Shoreditch flat", location: "138 kingsland road, London", description: "Spacious and in the center of the city.", price: 150, user: cecilia, guests: 4, bedrooms: 2)
...
treehouse = Flat.create!(title:"Treehouse in China", location: "China", description: "The Ohana in a tropical jungle setting will be your home while visiting the Big Island. A place to relax and commune with nature.", price: 31, user: molly, guests: 6, bedrooms: 3)
...
mountain = Flat.create!(title:"Remote mountain hut", location: "Japan", description: "Cosy getaway nestled in the beautiful mountains of Japan.", price: 99, user: lucas, guests: 2, bedrooms: 1)
...
frenchvilla = Flat.create!(title:"Luxury villa in France", location: "France", description: "This family friendly villa adorned wth sleek, modern style will give you a unique experience for your stay at Bandung.", price: 180, user: bruno, guests: 8, bedrooms: 4)
...
palace = Flat.create!(title:"The Cosy Palace", location: "Marrakech", description: "Let this be your Unique experience in Marrakech!", price: 115, user: cecilia, guests: 4, bedrooms: 2)
...
clapton = Flat.create!(title:"Quirky flat near Hackney", location: "34 Mildenhall Road, London", description: "Full of character with good transport links nearby", price: 100, user: cecilia, guests: 6, bedrooms: 3)
...
chelsea = Flat.create!(title:"Grand house in Chelsea", location: "10 Kings Road, London", description: "Walk out to be in the middle of the action on Kings Road.", price: 300, user: cecilia, guests: 7, bedrooms: 3)
...
brixton = Flat.create!(title:"Attic space in Brixton", location: "24 Beechdale Road, London", description: "Quiet location just round the corner from the buzz of Brixton village", price: 190, user: cecilia, guests: 5, bedrooms: 2)
